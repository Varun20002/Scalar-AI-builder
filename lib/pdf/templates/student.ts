...
// Warm Cream Editorial — Student persona
// Persona tint: sage (#6B8F71 at 10%) on cost_financing and entrance_test sections
...
export function renderStudentTemplate(content: PDFContent): string {
  const sectionsHTML = content.sections
    ...
    <div class="section ${s.section_type}">
      ...
      ${s.kb_citations.length ? `<p class="citation">From Scaler&rsquo;s program details</p>` : ''}
    </div>
  `
    )
    .join('')
...
<style>
  :root {
    ...
    --dark-band: #17120D;
    --persona-tint: rgba(107, 143, 113, 0.10);
    --persona-border: #6B8F71;
  }
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  /* persona tints — sage on cost/financing and entrance test */
...
<div class="page">
  ...
  <div class="hero">
    ...
    <div class="hero-label">Just for you &middot; ${escapeHtml(content.lead_name)}</div>
